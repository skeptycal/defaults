...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/defaults/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/defaults)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/defaults"
```
...
go get github.com/xxxxxx/defaults

cd ${GOPATH}/src/github.com/xxxxxx/defaults
...
> This is a copy of the example script available in the `cmd/example/defaults` folder:

```go
package main

import "github.com/skeptycal/defaults"
...
[issues]: (https://github.com/skeptycal/defaults/issues)
[pr]: (https://github.com/skeptycal/defaults/pulls)
